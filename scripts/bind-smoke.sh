...
echo "memnet_mode=$MEMNET_BACKEND proof_pass_claimed=false path_a_con29_not_bind path_b_mn_0d4f6178_narrow_not_bind cited_session=mn_b05a9869_not_bind" >&2
