...
Proof env: bounce **0.19.8** + TCP-shared. LIVE bind ingest **≥0.19.9**. SysMLEdge still owns `rev` / STALE / reproject. Path-B `mn_0d4f6178` CON **124** is **not** bind.
...
npm run bind:live   # same bind rules; Path A CON=29 ≠ bind; Path-B 124 ≠ bind
npm run mcp
# streamable HTTP: http://127.0.0.1:18776/mcp
```

LIVE operator boxes: [docs/proof/LIVE-BIND-CHECKLIST.md](docs/proof/LIVE-BIND-CHECKLIST.md). Attempt: [docs/proof/RUNLOG-2026-09-12-live-bind.md](docs/proof/RUNLOG-2026-09-12-live-bind.md). `mn_b05a9869` / `mn_0d4f6178` / `pin_map` are **not** bind.
