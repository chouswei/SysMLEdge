...
5. Timed H2H wall-clock + context on **0.19.8+TCP after bind** (**M5** / row **9**) on **Foam** `mn_0d4f6178` (CON **124** + nested). Gold-200 stays out. H2H on **p1-tiny** / `mn_be03c1a9` = **plumbing only**. MUST NOT soft-pass the wedge.
