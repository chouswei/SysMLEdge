...
`proof_pass_claimed: false`. Foam bind H2H + cold **FAIL** on **`mn_c7b75f2c`** ([RUNLOG-2026-09-12-h2h-foam-bind.md](RUNLOG-2026-09-12-h2h-foam-bind.md)). H2H on **p1-tiny** / `mn_be03c1a9` = **plumbing only**. MUST NOT soft-pass the wedge. Gold-200 stays out.
...
| H2H / cold | **FAIL** product bind: [RUNLOG-2026-09-12-h2h-foam-bind.md](RUNLOG-2026-09-12-h2h-foam-bind.md) (`mn_c7b75f2c` @ `f4679d848ccab5b26875eb9d2812171bb759ebf1`; context **1/3**, no_drop **3/3**, wall **0/3** P/F; cold FAIL). Plumbing: [RUNLOG-2026-09-12-h2h-plumbing.md](RUNLOG-2026-09-12-h2h-plumbing.md). **Track A tip** [#31](https://github.com/chouswei/SysMLEdge/pull/31): must-win **PASS**; wall **FAIL** **0/3** log-only — **≠ bind / ≠ product**. Bind GREEN ≠ `proof_pass`. Product bind H2H still logs wall as **P/F**. `proof_pass_claimed: false` |
