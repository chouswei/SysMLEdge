...
- Parser pin: git submodule [`vendor/sysml-v2-grammar`](https://github.com/daltskin/sysml-v2-grammar) **v2026.05.0**. Frozen `gold.json` counts stay the regex-era extract until Foam is re-run. ANTLR is not a proof pass.
