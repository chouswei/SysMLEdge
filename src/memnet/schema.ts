...
/** GitHub default-branch bytes of fixtures/memnet-session.map (Core H1 CI-pin). */
...
/**
 * CI-pin for the checked-in GitHub map. LIVE MEMNET_MAP_FILE copies are not this pin.
 * Changing the map without updating the pin is a fail, not a silent operator overwrite.
 */
